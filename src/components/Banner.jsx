  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-6 md:px-8 max-w-3xl">
        ...
        <p className="text-sm sm:text-base md:text-lg text-[#f1e0c6] leading-relaxed mb-8 font-light raleway">
          It’s coffee time – Sip & Savor – Relaxation in every sip! Get the
          nostalgia back!! Your companion of every moment — enjoy the beautiful
          moments and make them memorable.
        </p>

        <button className="btn raleway border-none bg-[#E3B577] hover:bg-[#d8a85e] text-[#2e1c0f] font-semibold px-8 py-2 rounded-full shadow-md hover:shadow-lg transition-all duration-300">
          Learn More
        </button>
      </div>
    </section>
