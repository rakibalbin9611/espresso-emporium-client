  ...
  return (
    <div>
      ...
      <div className="mt-8 mb-4 px-2">
        <Link
          to="/"
          className="flex items-center gap-2  text-2xl text-[#374151] font-semibold hover:text-[#b58973] transition duration-200 mb-10"
        >
          <span className="">←</span> Back to home
        </Link>
      </div>
      <div className="bg-[#F4F3F0] py-16 px-4 sm:px-8 md:px-16 lg:px-24 rounded-2xl max-w-5xl mx-auto">
        {/* Header Section */}
        ...
        <form onSubmit={handleAddCoffee} className="raleway space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <fieldset className="fieldset bg-white shadow-sm rounded-xl border border-base-300 p-4">
              <label className="label font-semibold text-[#374151]">Name</label>
              <input
                type="text"
                name="name"
          ...
          {/* Photo URL */}
          <fieldset className="fieldset bg-white shadow-sm rounded-xl border border-base-300 p-4">
            <label className="label font-semibold text-[#374151]">Photo</label>
            <input
              type="text"
              name="photo"
              className="input input-bordered w-full focus:outline-none focus:ring-2 focus:ring-[#D2B48C]"
